...
import { Monitor, Speaker, Radio, LayoutGrid, Tv, Volume2, Camera, Cpu, Headphones, X, ChevronLeft, ChevronRight, Play, FileText } from "lucide-react"
        ...
        <div className="grid md:grid-cols-2 h-full">
          ...
          <div className="relative bg-muted aspect-square md:aspect-auto">
            <div className="absolute inset-0 flex items-center justify-center p-8">
              <div className="w-full h-full bg-gradient-to-br from-primary/20 to-transparent rounded-xl flex items-center justify-center">
                <div className="text-center">
                  <product.icon className="h-24 w-24 text-primary/50 mx-auto" />
                  <p className="text-muted-foreground text-sm mt-4">Görsel {currentImage + 1}/3</p>
                </div>
              </div>
            </div>
